import { Body, Controller, Delete, Get, Inject, Param, Patch, Post, UploadedFiles, UseGuards } from '@nestjs/common';
...
export class ClothesController {
    ...
    async create(@Body() createClothes: RequestCreateClothesDto, @UploadedFiles() files: AWSS3Type) {
        return this.clothesInboundPort.create(createClothes, files);
    }
